...
const getProductionInformationById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const productionInfo = yield production_information_model_1.default.findById(id);
